...
import com.Excalibur.blog.entity.TagExample.Criteria;
import com.Excalibur.blog.entity.TagExample.Criterion;
...
public class TagSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getBlogCount() != null) {
            sql.SET("blog_count = #{record.blogCount,jdbcType=VARCHAR}");
        }
