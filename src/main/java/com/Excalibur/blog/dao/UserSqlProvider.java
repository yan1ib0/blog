...
import com.Excalibur.blog.entity.UserExample.Criteria;
import com.Excalibur.blog.entity.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getAdmin() != null) {
            sql.VALUES("admin", "#{admin,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAdmin() != null) {
            sql.SET("admin = #{record.admin,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getAdmin() != null) {
            sql.SET("admin = #{admin,jdbcType=TINYINT}");
        }
